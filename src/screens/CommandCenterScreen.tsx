  ...
  return (
    <div className="px-4 sm:px-6 pt-[max(14px,calc(env(safe-area-inset-top,0px)+14px))] pb-[max(86px,calc(env(safe-area-inset-bottom,0px)+86px))] animate-fade-in flex flex-col gap-4 sm:gap-6 min-h-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 flex-1">
        ...
        <div className="sm:col-span-2 neu-flat rounded-[24px] p-5 flex flex-col justify-between gap-3">
          <div className="flex justify-between items-center">
            <h2 className="text-[9.5px] sm:text-[10px] uppercase tracking-widest font-bold opacity-60">Google Workspace Hub</h2>
            <span className="text-[9px] sm:text-[10px] font-bold text-[var(--color-neu-accent)] uppercase tracking-wider">Keep &amp; Chat Connected</span>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-[var(--color-neu-text-light)] truncate">Spaces &amp; Live Messaging</p>
              </div>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-[var(--color-neu-text-light)] truncate">{keepNotes.length} Studio Notes</p>
              </div>
              <ArrowRight size={14} className="text-[var(--color-neu-text-light)] group-hover:text-[var(--color-neu-accent)] transition-colors shrink-0" />
            </button>
          </div>
